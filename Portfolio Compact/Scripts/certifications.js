import {S as e} from "./certifications.min.js";
!function() {
    ...
    function i(e) {
        ...
        const i = function(e) {
            const i = {};
            return e.integrity && (i.integrity = e.integrity),
            e.referrerpolicy && (i.referrerPolicy = e.referrerpolicy),
            "use-credentials" === e.crossorigin ? i.credentials = "include" : "anonymous" === e.crossorigin ? i.credentials = "omit" : i.credentials = "same-origin",
            i
        }(e);
        fetch(e.href, i)
    }
    ...
    const n = i.querySelector(".swiper")
      , o = e=>{
        ...
        const {offsetHeight: c, offsetWidth: l} = n
          , r = {
            "--expanding-collection-scale-x": o / l * .95,
            "--expanding-collection-scale-y": t / c * .95
        };
    ...
    new e(n,{
        ...
        on: {
            init(e) {
                ...
                e.slides.forEach((e=>{
                    ...
                    n.expandingCollectionClickHandler = ()=>{
                        o && e.classList.contains("swiper-slide-active") && i.classList.toggle("expanding-collection-opened")
                    }
                    ,
            ...
            beforeDestroy(e) {
                e.slides.forEach((e=>{
                    const i = e.querySelector(".expanding-collection-cover");
                    i && i.expandingCollectionClickHandler && i.removeEventListener("click", i.expandingCollectionClickHandler)
                }
                ))
            }
        }
